      ...
      <!--Barra de Navegacion -->
        ...
        <div class="row ">
            ...
            <div class="card col-sm-4 mb-2  mt-5 sticky-top">
                ...
                <br>
                <h5 class="text-secondary elegant-font mt-4"><b>Formulario Procedimientos</b></h5> 
              
              <form action="ControladorProcedimientos" method="POST" autocomplete="off" class="custom-form">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group text-left">
                                <label for="nombre" class="text-left">Nombre Procedimiento</label>
                                <input type="text" class="form-control" value="${User.getTipoprocedimiento()}" 
                                       id="proced" name="txtProced" placeholder="Ingrese Nombre" required
                                       pattern="[A-Za-z0-9\s]*"
            ...
            <%-- Tabla para listar --%>
            <div class="card col-sm-6 mb-4  mt-4 sticky-top">
                <div class="col-sm-11 mb-4 mt-5 sticky-top">
                    
                     <h4 class="text-secondary elegant-font mt-4"><b>Lista Procedimientos</b></h4> 
                    <br>
                    <div class=" table-container ml-4 md-4 table-responsive" >
                        <table id="miTabla" class="table table-striped table-hover sticky-top">
                            ...
                            <tbody>
                                <%
                                    List<Procedimientos> Lista = (List<Procedimientos>) request.getAttribute("listaProcedimientos");
                                    for (Procedimientos procedimientos : Lista) {%>
                                <tr>
                                    <td><%= procedimientos.getIdProcedimientos()%></td>
                                    <td><%= procedimientos.getTipoprocedimiento()%></td>                           

                                    <td>
                                        <div class="btn-group" role="group" aria-label="Acciones">

                                        <div class="mt-2">                                   
                                        <a href="ControladorProcedimientos?accion=editar&id=<%= procedimientos.getIdProcedimientos()%>" class="btn btn-outline-light btn-success"> 
                                            <!-- id  de un usuario se lo envio al controlador  en variable id -->  
                                            <i class="fas fa-pencil-alt"></i> <!-- Ícono de lápiz -->  
                                        </a>
                                         <a href="ControladorProcedimientos?accion=eliminar&id=<%=procedimientos.getIdProcedimientos()%>"
                ...
                <div class="form-group text-right">
                    <a href="ControladorProcedimientos?accion=listar" class="btn btn-primary mr-2"style="background-color: #0C4F5A; border-color:#0C4F5A;">
