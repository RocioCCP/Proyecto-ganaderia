<%-- 
    Document   : ListaMedicamentos
    Created on : 11/03/2024, 04:16:29 PM
...
<html>
    ...
    <body>
        ...
        <div class="row ">
            <hr>
            <div class="card col-sm-4 mb-3  mt-5 sticky-top">

                <br>

                 <h5 class="text-secondary elegant-font mt-4"><b>Formulario Medicamentos</b></h5> 
            
                <form action="ControladorMedicamentos" method="POST" autocomplete="off" class="custom-form">
                    ...
                    <div class="col-md-8 ">
                        ...
                        <div class="form-group text-left">
                            <label for="nombre" class="text-left">Medicamento</label>
                            <input type="text" class="form-control" value="${User.getMedicamento()}" 
                                   id="medica" name="txtMedicam" placeholder="Ingrese Nombre" required
                                   pattern="[A-Za-z0-9\s]*"
                                   title="Escribe un nombre que puede contener letras y/o números">
                            <small id="procdeError" class="error form-text text-muted">
                      ...
                      <div class="col-md-8 ">
                          <div class="form-group text-left">
                              <label for="labora" class="text-left">Laboratorio</label>
                              <input type="text" class="form-control" value="${User.getLaboratorio()}"  
                                     id="labora" name="txtLabora" placeholder="Ingrese Laboratorio" required
                                     pattern="[A-Za-z0-9\s]*"
                                     title="Escribe un nombre que puede contener letras y/o números">
                              <small id="procdeError" class="error form-text text-muted">
                                  Campo es obligatorio <span class="error">*</span>
            ...
            <%-- Tabla para listar --%>
            <div class="card col-sm-6 mb-4  mt-5 sticky-top">
                <div class="col-sm-11 mb-4 mt-5 sticky-top">

                  <h4 class="text-secondary elegant-font mt-4"><b>Lista Medicamentos</b></h4> 
                    <br>
                    <div class=" table-container ml-4 md-4 table-responsive" >
                        <table id="miTabla" class="table table-striped table-hover sticky-top">
                            ...
                            <tbody>
                                <%
                                    List<Medicamentos> Lista = (List<Medicamentos>) request.getAttribute("listaMedicamentos");
                                    for (Medicamentos medicamentos : Lista) {%>
                                <tr>
                                    <td><%= medicamentos.getIdMedicamento()%></td>
                                    <td><%= medicamentos.getMedicamento()%></td>      
                                    <td><%= medicamentos.getLaboratorio()%></td>                           

                                    <td>
                                        <div class="btn-group" role="group" aria-label="Acciones">

                                              <div class="mt-2">                                    
                                            <a href="ControladorMedicamentos?accion=editar&id=<%= medicamentos.getIdMedicamento()%>"  class="btn btn-outline-light btn-success"> 
                                                <!-- id  de un usuario se lo envio al controlador  en variable id -->  
                                                <i class="fas fa-pencil-alt"></i> <!-- Ícono de lápiz -->  
                                            </a>
                                                 <a href="ControladorMedicamentos?accion=eliminar&id=<%=medicamentos.getIdMedicamento()%>"
                ...
                <div class="form-group text-right">
                    <a href="ControladorMedicamentos?accion=listar"class="btn btn-primary mr-2"style="background-color: #0C4F5A; border-color:#0C4F5A;">
