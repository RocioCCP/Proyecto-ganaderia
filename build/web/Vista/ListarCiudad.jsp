    ...
    <body>
        ...
        <div class="row ">
            ...
            <div class="card col-sm-4 mb-2  mt-5 sticky-top">
                ...
                <h5 class="text-secondary elegant-font mt-4"><b>Formulario Ciudades</b></h5> 
                
                <form action="ControladorCiudad" method="POST" autocomplete="off" class="custom-form">
                    ...
                    <div class="col-md-8 ">
                        ...
                        <div class="form-group text-left">
                            <label for="ciudad" class="text-left">Nombre</label>
                            <input type="text" class="form-control" value="${User.getCiudad()}" 
                                  id="ciud" name="txtCiud" placeholder="Ingrese Nombre" required
                                   pattern="[A-Za-z0-9\s]*"
            ...
            <div class="card col-sm-6 mb-4  mt-4 sticky-top">
                <div class="col-sm-11 mb-4 mt-5 sticky-top">
                    ...
                    <h4 class="text-secondary elegant-font mt-4""><b>Lista Ciudades</b></h4> 
                    <br>
                    <div class=" table-container ml-4 md-4 table-responsive" >
                        <table id="miTabla" class="table table-striped table-hover sticky-top">
                            ...
                            <tbody>
                                <%
                                    List<Ciudad> Lista = (List<Ciudad>) request.getAttribute("listaCiudad");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Acciones">
                                            ...
                                            <div class="mt-2">
                                                <a href="ControladorCiudad?accion=editar&id=<%= ciudad.getIdCiudad()%>" class="btn btn-outline-light btn-success "> 
                                                    <!-- id de un usuario se lo envio al controlador en variable id -->  
                                                    <i class="fas fa-pencil-alt "></i> <!-- Ícono de lápiz -->  
                                                </a>
                                              <a href="ControladorCiudad?accion=eliminar&id=<%=ciudad.getIdCiudad()%>"
                ...
                <div class="form-group text-right">
                    <a href="ControladorCiudad?accion=listar" class="btn btn-primary mr-2"style="background-color: #0C4F5A; border-color:#0C4F5A;">
