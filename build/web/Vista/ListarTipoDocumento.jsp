    ...
    <body>
        ...
        <div class="row ">
            ...
            <div class="card col-sm-4 mb-2  mt-5 sticky-top">
                ...
                <br>
                <h4 class="text-secondary elegant-font mt-4"><b>Formulario Tipos de Documento</b></h4> 

                <form action="ControladorTipoDocumento" method="POST" autocomplete="off" class="custom-form">
                    ...
                    <div class="col-md-8 ">
                        ...
                        <div class="form-group text-left">
                            ...
                            <input type="text" class="form-control" value="${User.getNombredocumento()}"  
                                   id="nombre" name="txtNombre" placeholder="Ingrese Nombre" required
                                   pattern="[A-Za-z0-9\s]*"
                                   title="Escribe un nombre que puede contener letras y/o números">
                            <small id="ciudError" class="error form-text text-muted">
                    ...
                    <div class="form-group mt-5 text-center" style="border: none;">
            ...
            <%-- Tabla para listar --%>
            <div class="card col-sm-5 mb-4  mt-5 sticky-top">
                <div class="col-sm-11 mb-4 mt-5 sticky-top">

                    <h4 class="text-secondary elegant-font mt-4""><b>Lista Tipo de Documento</b></h4> 
                    <br>
                    <div class=" table-container ml-4 md-4 table-responsive" >
                        <table id="miTabla" class="table table-striped table-hover sticky-top">
                            ...
                            <tbody>
                                <%
                                    List<TipoDocumento> Lista = (List<TipoDocumento>) request.getAttribute("listaTipoDocumento");
                                    for (TipoDocumento tipoDocumento : Lista) {%>
                                <tr>
                                    <td><%= tipoDocumento.getIdTipodocumento()%></td>
                                    <td><%= tipoDocumento.getNombredocumento()%></td>                           

                                    <td>
                                        <div class="btn-group" role="group" aria-label="Acciones">

                                              <div class="mt-2">                                 
                                            <a href="ControladorTipoDocumento?accion=editar&id=<%= tipoDocumento.getIdTipodocumento()%>" class="btn btn-outline-light btn-success"> 
                                                <!-- id  de un usuario se lo envio al controlador  en variable id -->  
                                                <i class="fas fa-pencil-alt"></i> <!-- Ícono de lápiz -->  
                                            </a>
                                          <a href="ControladorTipoDocumento?accion=eliminar&id=<%=tipoDocumento.getIdTipodocumento()%>"
                ...
                <div class="form-group text-right">
                    <a href="ControladorTipoDocumento?accion=listar" class="btn btn-primary mr-2"style="background-color: #0C4F5A; border-color:#0C4F5A;">
